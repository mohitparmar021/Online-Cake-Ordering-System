	   	       ...
	   	       <div class=" main-card-content">
                    <div class="container">
                        <div id="print-content">
                                ...
                                <%
                                      int adorderid=(Integer)request.getAttribute("adorderid");
                                      ...
                                      stmt=con.createStatement();
                               	     ...
                               	     String query="select * from advance_order_info where  ad_id='"+adorderid+"'";
                                    ...
                                    <label class="font-weight-bold">Total :</label> <span>&nbsp; Rs.<%=rs.getFloat("total_price") %> /  ( Paid ) </span><br>     
                                 </form>
                <%
                               	   }
